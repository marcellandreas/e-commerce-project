        ...
        <div className="images h-96">
          ...
          <div className=" overlay flex items-center gap-2 justify-center absolute bottom-0 left-0 right-0 m-5">
            ...
            <button
              ...
              className=" love-to-cart-btn product-btn primary-btn"
            >
              <IoMdHeart size={23} />
            </button>
          </div>
          ...
          <div className="overlay-bg" onClick={closeModal}>
            <div className="modal-overlay" onClick={closeModal}>
              ...
              >
                ...
                <div className="modal-details w-1/2 overflow-y-scroll p-9 h-[500px]">
                  ...
                  <div className="flex items-center gap-3">
                    <input
                      type="text"
                      value="1"
                      className="w-12 h-12 text-primary outline-none border-primary px-4"
                    />
                  ...
                  <button
                    className="close-btn absolute top-0 right-0 w-12 h-12 flex justify-center items-center bg-primary text-white"
                    onClick={closeModal}
                  >
                    <IoClose size={20} />
                  </button>
