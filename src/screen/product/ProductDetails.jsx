...
import {
  ...
  Caption,
  Title,
} from "../../components/Molecules/MoleculesComponents";
...
export const ProductDetails = () => {
  ...
  const CustomPage = ({ index, onClick }) => {
    return (
      <div>
        <img src={images[index].image} onClick={onClick} />
      </div>
    );
  };
    ...
    <>
      <section className=" container mt-32 slideproduct">
        <div className="flex justify-between flex-col lg:flex-row">
          <div className="images lg:w-1/2  z-10">
            <div>
              <Slider {...settings}>
          ...
          <div className="deatils lg:w-1/2 px-16 pt-16">
                ...
                {color.map((colorOption, index) => (
                  <div
                    ...
                    className={`w-4 h-4 rounded-full -mt-3 cursor-pointer border-gray-300 ${
                      handleColorClick === colorOption.value ? "selected" : ""
                    }`}
            ...
            <div className="flex items-center-gap-3">
              ...
              <button className="h-12 primary-btn">Add to Cart</button>
            </div>
        ...
        <div className="flex justify-between flex-col lg:flex-row my-10">
          <div className="w-1/2">
            ...
            <Caption>
              Designed for superior child comfort, OneFitTM provides extra
              ...
              OneFitTM accommodates tiny passengers from the very start with a
...
export function ProductDetailsBox({ title, desc }) {
  return (
    <>
